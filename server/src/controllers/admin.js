...
const { getAllUsersStatsLogic, getUsersInfoLogic, restoreUserLogic, deleteUserLogic, getUserLogicSuper } = require("../logic/admin");
...
const getUserSuper = catchedAsync(async (req, res) => {
    const { id } = req.params;
    const user = await getUserLogicSuper(id);
...
module.exports = { getUserStats, getUsersInfo, restoreUser, deleteUser,getUserSuper };